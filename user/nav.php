    ...
    <div class="main-menu menu-fixed  menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
		  ...
		  <li class=" nav-item <?php echo $appointments;?>"><a href="appointments"><i class="la la-calendar"></i><span class="menu-title" data-i18n="Templates">Appointments</span></a></li>
          <li class=" nav-item <?php echo $profile;?>"><a href="profile"><i class="la la-user"></i><span class="menu-title" data-i18n="Templates">Profile</span></a></li>
